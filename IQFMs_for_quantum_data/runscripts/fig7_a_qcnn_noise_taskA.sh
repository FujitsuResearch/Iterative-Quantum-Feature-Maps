...
EPOCH_OUT=1000  # Number of training epochs
...
do
for NOISE in 0.00 0.05 0.10 0.15 0.20 0.25 0.30 # Noise level
do
    # Save directory for results
    SAVE=../results/$SCRIPT_NAME/$DAT\_vdepth_$VDEPTH\_lr_$LR\_epoch_$EPOCH_OUT\_noise_$NOISE\_scale_$SCALE\_thres_$THRES
