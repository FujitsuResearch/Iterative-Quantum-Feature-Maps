...
SCALE='8.0'
TASK='classification'
TYPE_SAMPLES='tensor' # One step IQFMs
DAT='Ising_all'  # Dataset name Task A
...
do 
for LAYERS in '36,36,36,36,36,36' #layers of the feature map
do
for NOISE in 0.30 0.25 0.20 0.15 0.10 0.05 0.00
do
SAVE=../results/$SCRIPT_NAME/$TYPE_SAMPLES\_$TASK\_qfm_$QFM\_basis_$BASIS\_rec_$RECORD\_shots_$SHOTS\_obs_$OBS\_layers_$LAYERS\_lr_$LR\_rc_$RC\_vdepth_$VDEPTH\_noise_$NOISE\_epoch_$EPOCH_OUT
