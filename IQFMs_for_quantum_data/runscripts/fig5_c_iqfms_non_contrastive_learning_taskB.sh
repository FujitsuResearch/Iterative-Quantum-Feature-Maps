...
EPOCH_IN=40
EPOCH_OUT=0 # non_contrastive_learning
...
do 
for LAYERS in '32,32' '32,32,32' '32,32,32,32' '32,32,32,32,32' '32,32,32,32,32,32' '32,32,32,32,32,32,32,32,32,32,32' #layers of the feature map
do
